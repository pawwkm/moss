...
static void apply_changes(Editor* editor, Tab* tab, View* view, Buffer* buffer, bool is_undo)
{    
...
void do_changes(Editor* editor)
{
    ...
    apply_changes(editor, tab, view, buffer, false);
}
...
void undo_changes(Editor* editor)
{
    ...
    apply_changes(editor, tab, view, buffer, true);
